...
parser = argparse.ArgumentParser(description='generate training data for DCFNet.')
parser.add_argument('-v', '--visual', dest='visual', action='store_true', help='whether visual crop.')
parser.add_argument('-o', '--output_size', dest='output_size', default=125, type=int, help='crop output size.')
parser.add_argument('-p', '--padding', dest='padding', default=2, type=float, help='crop padding size')
